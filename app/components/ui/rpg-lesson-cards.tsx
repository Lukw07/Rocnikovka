  ...
  >
    <div className="flex items-center justify-between p-6 gap-6">
      <div className="flex-1 min-w-0">
        <h3 className="text-2xl font-cinzel font-bold text-foreground break-words">{title}</h3>
        {children}
      </div>
      <div className="flex flex-col gap-4 text-right flex-shrink-0">
        {students !== undefined && (
        ...
        {xp && (
          <div className="flex items-center justify-end gap-2 text-sm">
            <div className="w-5 h-5 rounded-full border-2 border-primary flex items-center justify-center text-xs font-bold text-primary flex-shrink-0">XP</div>
  ...
  >
    <div className="p-6 space-y-3">
      <div className="flex items-center gap-4">
        {icon ? (
          <div className="w-12 h-12 rounded-lg bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-primary text-xl font-bold flex-shrink-0">
            {icon}
          </div>
        ) : number && (
