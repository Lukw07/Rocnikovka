...
const rpgButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-b from-primary via-primary to-primary/90 text-primary-foreground shadow-lg dark:shadow-xl hover:shadow-xl dark:hover:shadow-[0_10px_30px_rgba(177,142,255,0.4)] hover:-translate-y-1 active:translate-y-0.5 active:shadow-md border-2 border-primary/30 dark:border-primary/50 before:absolute before:inset-0 before:bg-gradient-to-t before:from-white/25 before:via-transparent before:to-transparent dark:before:from-white/10 before:pointer-events-none after:absolute after:inset-x-0 after:top-0 after:h-2 after:bg-gradient-to-b after:from-purple-300/70 after:via-cyan-300/60 after:to-transparent dark:after:from-purple-400/50 dark:after:via-cyan-400/40 dark:after:to-transparent after:pointer-events-none",
        secondary:
        ...
        accent:
          "bg-gradient-to-b from-accent via-accent to-accent/90 text-accent-foreground shadow-lg dark:shadow-xl hover:shadow-xl dark:hover:shadow-[0_10px_30px_rgba(0,230,255,0.4)] hover:-translate-y-1 active:translate-y-0.5 active:shadow-md border-2 border-accent/30 dark:border-accent/50 before:absolute before:inset-0 before:bg-gradient-to-t before:from-white/25 before:to-transparent dark:before:from-white/10 before:pointer-events-none after:absolute after:inset-x-0 after:top-0 after:h-2 after:bg-gradient-to-b after:from-cyan-300/70 after:via-purple-300/60 after:to-transparent dark:after:from-cyan-400/50 dark:after:via-purple-400/40 dark:after:to-transparent after:pointer-events-none",
        destructive:
