...
const rpgButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-b from-primary via-primary to-primary/90 text-primary-foreground shadow-lg dark:shadow-xl hover:shadow-xl dark:hover:shadow-[0_10px_20px_rgba(230,184,0,0.3)] hover:-translate-y-1 active:translate-y-0.5 active:shadow-md border border-primary/20 dark:border-primary/30 before:absolute before:inset-0 before:bg-gradient-to-t before:from-white/20 before:via-transparent before:to-transparent dark:before:from-white/5 before:pointer-events-none after:absolute after:inset-x-0 after:top-0 after:h-1 after:bg-gradient-to-b after:from-white/30 after:via-transparent after:to-transparent dark:after:from-white/10 after:pointer-events-none",
        secondary:
        ...
        accent:
          "bg-gradient-to-b from-accent via-accent to-accent/90 text-accent-foreground shadow-lg dark:shadow-xl hover:shadow-xl dark:hover:shadow-[0_10px_20px_rgba(38,198,218,0.3)] hover:-translate-y-1 active:translate-y-0.5 active:shadow-md border border-accent/20 dark:border-accent/30 before:absolute before:inset-0 before:bg-gradient-to-t before:from-white/20 before:to-transparent dark:before:from-white/5 before:pointer-events-none",
        destructive:
      ...
      glow: {
        true: "hover:shadow-glow-primary dark:hover:shadow-[0_0_20px_rgba(230,184,0,0.5)]",
        false: "",
      },
    },
    defaultVariants: {
